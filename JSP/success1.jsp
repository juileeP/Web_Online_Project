...
<p>Create a new account. Register <a href="reg.jsp">Here. </a><br/> OR
<a href="index2.html">Please Login</a>
<%} else {
%>
<br>
<font color="red"><b>Welcome <%=session.getAttribute("userid")%> ,</b></font>
<br><br><br>
<b>Please review your Contact Information</b><br><br>
...
%>
	<form id="userForm" method=GET action="user/userController">
